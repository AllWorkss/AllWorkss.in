...
import CardSpotlight from './ui/3d/CardSpotlight';
import Card3DTilt from './ui/3d/Card3DTilt';
...
export default function ServiceCard({ service, pillarKey, id, icon, title, description, features, whatsappMessage, className }) {
  ...
  return (
    <Card3DTilt maxTilt={8} className="h-full">
      <CardSpotlight className={`h-full p-6 flex flex-col justify-between ${className || ''}`}>
        <div>
          {/* Category Icon & Badge */}
